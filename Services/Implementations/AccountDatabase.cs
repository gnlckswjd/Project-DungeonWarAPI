...
public class AccountDatabase : IAccountDatabase
{
    ...
    public async Task<ErrorCode> RollbackAccountAsync(int accountId)
    {
    ...
    public async Task<(ErrorCode errorCode, int playerId)> VerifyAccount(string email, string password)
    {
